...
python ./analysis/scripts/RQ1/combine.py ./raw-data/features.csv ./raw-data/float_mflops.csv c
python ./analysis/scripts/RQ1/combine.py ./raw-data/features.csv ./raw-data/sequential-chrome-single.csv wasm
python ./analysis/scripts/RQ3/combine.py ./raw-data/features.csv ./raw-data/float_mflops.csv ./raw-data/float_mflops_with_papi.csv c
